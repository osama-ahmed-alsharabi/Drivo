      ...
      child: Scaffold(
        body: Directionality(
          ...
          child: LiquidPullToRefresh(
            ...
            height: 100, // Pull-down distance to trigger refresh
            animSpeedFactor: 1.5, // Animation speed
            showChildOpacityTransition: false, // Disable fade effect
            onRefresh: () async {
              // Create a Completer to ensure refresh completes
              final completer = Completer();

              try {
                await Future.wait([
                  BlocProvider.of<ExchangeCubit>(context).loadExchangeRate(),
                  BlocProvider.of<DeliveryFeeCubit>(context).loadDeliveryFee(),
                ]);
                completer.complete();
              } catch (e) {
